...
namespace Nightmare
{
    public class PhysicsHelper : MonoBehaviour
    {
        ...
        Dictionary<Collider2D, PlatformEffector2D> m_PlatformEffectorCatcher = new Dictionary<Collider2D, PlatformEffector2D>();
        ...
        void Awake()
        {
            ...
            PopulateColliderDictionary(m_PlatformEffectorCatcher);
        ...
        {
            return Instance.m_PlatformEffectorCatcher.ContainsKey(collider);
        }
        ...
        {
            return Instance.m_PlatformEffectorCatcher.TryGetValue(collider, out platformEffector);
        }
